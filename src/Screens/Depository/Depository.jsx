    ...
    return (
        <div className='Depository'>
            ...
            <div className="section-3">
                ...
                <p>Depositories are used by the general public for a variety of purposes. They eliminate the owner's risk of owning physical goods in the first place, which is important. Customers can deposit money into time and demand deposit accounts at banks and other financial institutions. A certificate of deposit (CD) is an interest-bearing account with a set maturity date, whereas a demand deposit account (such as a checking or savings account) retains money until they are needed for withdrawal. Security deposits, such as stocks or bonds, are another option for deposits. There are two options for depositing these assets: they can be held electronically or they can be dematerialized and stored as a certificate.</p>
                </div>
                <div className="mutualFund-header">
                    <h1>What are CDSL and NSDL?</h1>
                </div>
                <div className="section-3-content">
                <p>As an investor, you should be aware of the two working depositories in India, which make the process of purchasing and selling shares possible.
