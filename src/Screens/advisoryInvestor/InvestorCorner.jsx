    ...
    <main className="investor-page">
            <section className="investor-banner container-padding">
                <div className="content-section">
                    ...
                    <h3 className="section-subtitle">Statements about latest rules and regulations set by regulatory authorities...</h3>
                </div>
            ...
            <section className="investor-attention container-padding">
                ...
                <div className="attention-container">
                    <div className="attention-wrapper">
                        <InvestorAttentionCard isActive={true} data="Investors must beware of fixed guaranteed / regular returns"/>
            ...
            <section className="beware-section container-padding">
                ...
                <img src="/images/beware.png" alt="" className="beware-img" />
                <p className="section-subtitle">
                Avoid fixed-return, guaranteed-return, regular-return, and capital-protection programs. Brokers, their authorized representatives, or any of their colleagues are not permitted to provide fixed, guaranteed, consistent returns on your investment, or
                    <br /><br />
                    capital protection, nor are they permitted to engage in any loan agreements with you to cover the interest on the funds you offer.
