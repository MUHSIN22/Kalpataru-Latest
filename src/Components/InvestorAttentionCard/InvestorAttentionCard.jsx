...
export default function InvestorAttentionCard({data,isActive}) {
  ...
  return (
    <div className={"investor-attention-card "+(isActive?"investor-attention-card--active":null)}onClick={investorAttentionActivator}>
